...
export default function AddLiquidityPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/lp/add-liquidity", {
        method: "POST",
    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="container mx-auto px-8 py-8 max-w-4xl w-full">
        ...
        <Card className="border-cyan-500/20">
          <CardHeader>
            <CardTitle className="text-3xl">Add Liquidity</CardTitle>
            <CardDescription className="text-base">Deposit tokens to an existing pool and earn fees</CardDescription>
          </CardHeader>
          <CardContent>
            {!walletConnected ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  <div className="space-y-3">
                    <Label htmlFor="tokenAAmount" className="text-base">
                      Token A Amount
                    </Label>
                    <Input
                      id="tokenAAmount"
                  ...
                  <div className="space-y-3">
                    <Label htmlFor="tokenBAmount" className="text-base">
                      Token B Amount
                    </Label>
                    <Input
                      id="tokenBAmount"
